...
namespace CarDrive.Systems
{
    ...
    public class CarDriveWorldSettings : ScriptableObject
    {
        ...
        [Tooltip("체크하면 화면 밖 <b>먼</b> 지면을 끕니다. (가까운 것은 terrainNearDistance 가 지킵니다) " +
                 "예전에 이 옵션이 손해였던 것은 시야를 돌릴 때 여러 장이 한 프레임에 켜졌기 때문인데, " +
                 "이제 maxSurfaceActivationsPerFrame 이 그것을 나눠 줍니다.")]
        public bool cullTerrainSurface = true;
