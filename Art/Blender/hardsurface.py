...
class Mass:
    ...
    def to_parts(self, name, min_faces=2500):
        """
        ...
        기준은 <b>다시 올렸습니다.</b> 데크 소품을 얹자 중간 크기 프리셋 몇이 문턱을
        넘어가 드로우가 69 → 86 이 되었는데, 그 프리셋들은 어차피 통째로 화면에
        들어오므로 나눠도 걸러지는 것이 없었습니다. 지금 나눌 값어치가 있는 것은
        시타델(73,884)과 거주 구간(6,576)뿐입니다.
